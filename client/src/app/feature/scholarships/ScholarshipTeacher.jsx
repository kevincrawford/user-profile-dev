    ...
    return (
      <div className='article-wrap'>
        <div className='article'>
          ...
          <p>
            SPEDxchange is offering a $1,000 scholarship for undergraduate or
            graduate students that are interested in working with special needs
            students.
          </p>
          <p>
            This award is for undergraduate or graduate students that are
            pursuing a degree in folowing special education or a related fields:
          </p>
          <p>
